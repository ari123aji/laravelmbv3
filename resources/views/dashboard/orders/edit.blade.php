...
<div class="col-lg-8">
    ...
    @csrf
        ...
        <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" required value="{{ old('slug', $order->slug)}}">
            @error('slug')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control @error('deadline') is-invalid @enderror" id="deadline" name="deadline"
             required autofocus value="{{ old('deadline', $order->deadline) }}">
            @error('deadline')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
